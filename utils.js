...
var _this = this;
var Web3 = require('web3'); // necessary for Node.js
var cliArgs = process.argv.slice(2);
var provider = cliArgs[0];
var Chain;
(function (Chain) {
    Chain[Chain["ETH"] = 0] = "ETH";
})(Chain || (Chain = {}));
...
var isMinedUncleBlock = function (chain, blockHeight, blockhash, coinbaseAddr) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, web3.eth.getBlock(blockHeight)
                .then(function (block) {
                if (!block)
                    throw new Error("".concat(chain, " at block height ").concat(blockHeight, " does not exist"));
                return block;
            })
                .then(function (block) {
                ...
                if (block.uncles.length > 0)
                    return true;
                throw new Error("".concat(chain, " at block height ").concat(blockHeight, " with hash ").concat(blockhash, " does not exist"));
            })];
    });
}); };
